...
return [
    ...
    'backend' => [
        'frontName' => ($_ENV['MAGENTO_BACKEND_FRONTNAME'] != '') ? $_ENV['MAGENTO_BACKEND_FRONTNAME'] : 'admin'
    ],
    'queue' => [
        'consumers_wait_for_messages' => 0
    ],
    'crypt' => [
        'key' => ($_ENV['MAGENTO_CRYPT_KEY'] != '') ? $_ENV['MAGENTO_CRYPT_KEY'] : '7bb131f36720dd1f862da4bf22372a11'
    ],
    'db' => [
        'table_prefix' => '',
        'connection' => [
